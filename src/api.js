...
export default {
    ...
    menuInfo: [
        ...
        {text: 'KTV', icon: require('./img/Home/icon_homepage_KTVCategory.png')},
        {text: '优惠买单', icon: require('./img/Home/icon_homepage_default.png')},
        {text: '周边游', icon: require('./img/Home/icon_homepage_foottreatCategory.png')},
        {text: '生活服务', icon: require('./img/Home/icon_homepage_lifeServiceCategory.png')},
        {text: '休闲娱乐', icon: require('./img/Home/icon_homepage_entertainmentCategory.png')},
        {text: '丽人/美发', icon: require('./img/Home/icon_homepage_beautyCategory.png')},
        {text: '购物', icon: require('./img/Home/icon_homepage_shoppingCategory.png')},

        {text: '丽人/美发', icon: require('./img/Home/icon_homepage_beautyCategory.png')},
        {text: '电影', icon: require('./img/Home/icon_homepage_movieCategory.png')},
        {text: '周边游', icon: require('./img/Home/icon_homepage_foottreatCategory.png')},
        {text: '酒店', icon: require('./img/Home/icon_homepage_hotelCategory.png')},
        {text: '优惠买单', icon: require('./img/Home/icon_homepage_default.png')},
        {text: '休闲娱乐', icon: require('./img/Home/icon_homepage_entertainmentCategory.png')},
        {text: 'KTV', icon: require('./img/Home/icon_homepage_KTVCategory.png')},
    ]
